        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <g:link class="nav-link" controller="instructor" action="profile">
                ...
                <li class="nav-item">
                    <g:link class="nav-link" controller="work" action="index" id="${group.id}">
                ...
                <li class="nav-item">
                    <g:link class="nav-link" controller="group" action="students" id="${group.id}">
                        <i class="nav-icon fa fa-users"></i>
                        <p>
                            Students
                            <span class="right badge badge-danger">
                                ${noticeboard.CountService.groupStudents(group)}
                            </span>
                        </p>
                    </g:link>
                </li>
