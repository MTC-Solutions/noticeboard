                ...
                <div class="col-lg-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <g:if test="${!student.modules}">
                                        No registered module
                                    </g:if>
                                    <g:each var="module" in="${student.modules}">
                                        <g:link controller="notification" action="index" id="${module.id}">
                                            <i class="fa fa-book"></i>
                                            ${module.moduleCode}
                                            <span class="badge badge-danger pull-right"> ${module.notifications.size()} </span><br>
                                        </g:link>
                                    </g:each>
