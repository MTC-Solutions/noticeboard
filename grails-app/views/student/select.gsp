    ...
    <div class="card mb-3 card-primary">
        <div class="card-header">
            <h5 class="card-title">
                ...
                Students
                <g:link class="btn btn-success btn-sm" controller="student" action="create" id="${institution.id}">
                    <i class="fa fa-plus"></i>
                    Create
                </g:link>
                <g:link class="btn btn-danger btn-sm" controller="student" action="upload" id="${institution.id}">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                    <g:each var="student" in = "${institution.students}">
                        <tr>
                            <td>${student.title}</td>
