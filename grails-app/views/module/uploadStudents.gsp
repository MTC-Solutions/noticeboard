...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card card-primary">
            ...
            <!-- form start -->
            <div class="card-body">
                <g:uploadForm class="form-validation" useToken="true" action="extractStudents" id="${module.id}" method="POST">
                    ...
                    <sec:ifAnyGranted roles="${noticeboard.IdentityService.ROLE_ADMIN}, ${noticeboard.IdentityService.ROLE_SUPER_ADMIN}">
                        <g:link class="btn btn-danger" action="students" id="${module.id}">
